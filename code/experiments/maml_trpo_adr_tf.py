...
import yaml
from common import set_seed, progress, parameters_to_vector, PolicyNetwork, ValueNetwork, surrogate_loss, HVP, conjugate_gradients, line_search, adapt, SVPG, Discriminator, make_vec_envs, collect_rollout_batch
...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        df = pd.DataFrame(list(zip(plot_tr_rewards_mean,
                          ...
                          columns =['Rewards_Tr_Mean', 'Rewards_Tr_Std', 'Rewards_Val_Mean', 'Rewards_Val_Std', 'Rewards_Eval_Mean', 'Rewards_Eval_Std', 'Rewards_Disc_Mean', 'Rewards_Disc_Std', 'Total_Timesteps'])
