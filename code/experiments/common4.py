...
class SVPG:
    ...
    def step3(self):
        ...
        """
        self.simulation_instances = np.zeros((self.n_particles, self.dr))
        ...
        self.masks = np.ones((self.n_particles, 1))
        ...
        for i in range(self.n_particles):
            ...
            self.simulation_instances[i] = current_sim_params
    ...
    def train3(self, simulator_rewards):
        policy_grads = []
        parameters = []
        ...
        for i in range(self.n_particles):
            ...
            particle_rewards = tf.expand_dims(tf.convert_to_tensor(simulator_rewards[i],dtype=tf.float32),0)
