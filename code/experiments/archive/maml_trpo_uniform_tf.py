...
import yaml
from common import set_seed, progress , parameters_to_vector, PolicyNetwork, ValueNetwork, surrogate_loss, HVP, conjugate_gradients, line_search, adapt, make_vec_envs, collect_rollout_batch, reset_tasks
import timeit
    ...
    for seed in seeds:
        ...
        for episode in episodes:
            ...
            for task in tasks:
                ...
                reset_tasks(env_rand,[task] * n_workers)
            ...
            if evaluate and t_eval>eval_freq:
                ...
                eval_rewards=[]
                lower = 0.
                eval_tasks = env.sample_tasks(eval_eps)
