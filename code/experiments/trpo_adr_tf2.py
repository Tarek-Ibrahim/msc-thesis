...
import yaml
from common2 import set_seed, progress , parameters_to_vector, PolicyNetwork, ValueNetwork, surrogate_loss, HVP, conjugate_gradients, line_search, SVPG, Discriminator, collect_rollout_batch, make_vec_envs
...
if __name__ == '__main__':
    ...
    file_name="trpo_adr_cont2" #os.path.basename(__file__).split(".")[0]
